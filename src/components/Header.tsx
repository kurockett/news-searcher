...
const Header = () => {
    return (
        <header className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
                    ...
                    <path fill-rule="evenodd"
                          ...
                          clip-rule="evenodd"/>
                                        ...
                                        <p className="ml-2">
                                            Customizing your
                                            <code
                                                className="text-sm font-bold text-gray-900">tailwind.config.js</code> file
                                        </p>
                                    </li>
                                    <li className="flex items-start">
                <span className="h-6 flex items-center sm:h-7">
                            ...
                            <div className="pt-6 text-base leading-6 font-bold sm:text-lg sm:leading-7">
                                ...
                                <p>
                                    <a href="https://tailwindcss.com/docs"
                                       className="text-cyan-600 hover:text-cyan-700"> Read the docs &rarr; </a>
                                </p>
                            </div>
                        </div>
                    </div>
